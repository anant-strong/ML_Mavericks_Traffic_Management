...
class Main:
    ...
    background = pygame.image.load('data/intersection.png')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("Traffic Congestion Management")

    # Loading signal images and font
    redSignal = pygame.image.load('data/signals/red.png')
    yellowSignal = pygame.image.load('data/signals/yellow.png')
    greenSignal = pygame.image.load('data/signals/green.png')
